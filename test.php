...
$extraInfo['lang']                 = 'en';
$track = $track->createTracking('cuckooexpress','RP325552475CN',$extraInfo);
...
//$track = $track->getSingleTrackingResult("cuckooexpress","RP325552475CN",'en');

//6 create muti tracking number (创建多个运单号)
//$items = array(
//    array(
//        'tracking_number' => 'RP325552475CN',
//        'carrier_code'    => 'cuckooexpress',
//        'title'          => '4PX page',
...
//$extraInfo['destination_code'] = 'US';
//$extraInfo['status']       = '7';
//$track = $track->updateTrackingItem('cuckooexpress','RP325552475CN',$extraInfo);

//8 Delete a tracking item (删除单个运单号)
//$track = $track->deleteTrackingItem('cuckooexpress','RP325552475CN');

//9 Get realtime tracking results of a single tracking (获取单个运单号实时物流信息)
// $track = $track->getRealtimeTrackingResults("cuckooexpress","RP325552475CN",array("lang"=>'en'));

//10 Modify courier code (修改运输商简码)
//$r = $track->updateCarrierCode("RP325552475CN","cuckooexpress","china-ems");
...
//$date = array();
//$data[] = array("tracking_number"=>"RP325552475CN","carrier_code"=>"cuckooexpress");
...
//$data = array();
//$data[] = array("original"=>"CN","destination"=>"US","carrier_code"=>"cuckooexpress");
